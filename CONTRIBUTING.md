...
Welcome to `opensemantic.characteristics.basic` contributor's guide.
...
If you experience bugs or general issues with `opensemantic.characteristics.basic`, please have a look
...
You can help improve `opensemantic.characteristics.basic` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`opensemantic.characteristics.basic` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `opensemantic.characteristics.basic`'s files. While this mechanism can
...
```
conda create -n opensemantic.characteristics.basic python=3 six virtualenv pytest pytest-cov
conda activate opensemantic.characteristics.basic
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/opensemantic.characteristics.basic.git
   cd opensemantic.characteristics.basic
   ```
...
5. Install [pre-commit]:
   ...
   `opensemantic.characteristics.basic` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/opensemantic.characteristics.basic
[issue tracker]: https://github.com/<USERNAME>/opensemantic.characteristics.basic/issues
